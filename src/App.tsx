...
const CLUB_HISTORIES: Record<string, string> = {
  ...
  bodoglimt:
    'FK Bodø/Glimt ble stiftet i 1916 og representerer Nord-Norges stolthet. Klubben var lenge underdog i norsk fotball, men tok et historisk sprang med seriegull i 2020 – det første laget nord for polarsirkelen som vant Eliteserien. Under trener Kjetil Knutsen ble Glimt kjent for høyintensiv, offensiv fotball og imponerende resultater i Europa, inkludert seire over Roma. Aspmyra Stadion har blitt et symbol på klubbens fremgang, profesjonalitet og evne til å forene regionen bak sitt karakteristiske gule lag.',
  brann:
    'Stiftet i 1908, er Sportsklubben Brann fra Bergen blant landets mest tradisjonsrike klubber. Med seriemesterskap i 1961-62, 1963 og 2007 samt flere cupgull, har Brann vært både velsignet og forbannet med ekstreme svingninger mellom triumf og nedrykk. Klubben har en av Norges mest lidenskapelige supporterbaser – «Brann-fansen» fyller Brann Stadion med unikt trøkk. Under Eirik Horneland har klubben gjenreist seg sportslig og kulturelt, og satser på en bærekraftig fremtid for bergensk fotball.',
  fredrikstad:
    'Fredrikstad Fotballklubb, stiftet i 1903, var i flere tiår landets mestvinnende lag. Klubben vant ni seriemesterskap og elleve NM-gull og satte standarden for norsk klubbfotball. FFK var pioner innen organisering, trening og profesjonalisering. Etter gullårene falt klubben ned i lavere divisjoner, men stoltheten i plankebyen forsvant aldri. Fredrikstad Stadion, åpnet i 2007, symboliserer ambisjonen om å vende tilbake til toppen og bygge videre på en arv av tradisjon, entusiasme og lokalpatriotisme.',
  hamkam:
    'Hamarkameratene ble etablert i 1918 og har sitt hjem på Briskeby Stadion. Klubben er kjent for sin tette tilknytning til lokalsamfunnet på Hamar og for den grønne drakten som symboliserer stabilitet og arbeidsmoral. HamKam har vekslet mellom divisjoner, men opparbeidet seg respekt for organisert, ærlig fotball. På 1970-tallet etablerte de seg i toppdivisjonen, og tidlig på 2000-tallet førte Ståle Solbakken laget til opprykk. Klubben jobber i dag for å bli et varig Eliteserie-lag, tuftet på regionens stolthet og fellesskap.',
  haugesund:
    'FK Haugesund ble dannet i 1993 etter sammenslåing av Haugar og Djerv 1919. Klubben nådde raskt Eliteserien og har etablert seg som en stabil toppklubb fra Vestlandet. FKH er kjent for solid drift, gode spillerkjøp og utvikling av lokale talenter. Med Haugesund Stadion som hjemmebane og en lojal supporterbase har laget flere ganger kvalifisert seg til Europa-spill. Klubben kombinerer profesjonell struktur med sterk lokal identitet og representerer regionens hardtarbeidende fotballkultur.',
  kfumoslo:
    'KFUM Oslo ble grunnlagt i 1939 og har røtter i kristne verdier og ungdomsarbeid. Klubben har bygget seg opp som et forbilde for sosialt ansvar og utvikling av unge spillere. Fra amatørnivå til Eliteserien har reisen vært eventyrlig, båret frem av entusiasme, dugnadsånd og offensiv fotball. «Kåffa» spiller på Ekeberg og er kjent for et inkluderende miljø, der fokus på mennesket står like sterkt som resultatene. KFUM viser at breddens verdier kan føre helt til toppen.',
  kristiansund:
    'Kristiansund Ballklubb ble etablert i 2003 gjennom sammenslåing av Clausenengen FK og Kristiansund FK. Klubben representerer hele Nordmøre og har på få år tatt steget fra lokal til nasjonal størrelse. KBK rykket opp til Eliteserien i 2017 og ble raskt kjent for offensiv, underholdende fotball og sterkt samhold. Under slagordet «Vi e KBK» har laget bygd en tydelig identitet, med Kristiansund Stadion som sentrum for byens stolthet. Klubben står som et eksempel på profesjonalitet i små forhold.',
  lillestrom:
    'Lillestrøm Sportsklubb ble stiftet i 1917 og har en rik historie preget av arbeidermiljø og sterk rivalisering med Vålerenga. Klubben har vunnet flere seriemesterskap og cupgull og var spesielt dominerende på 1970- og 1980-tallet. LSK er kjent for tøft, fysisk spill og en lojal supportergruppe – Kanarifansen – som preger stemningen på Åråsen Stadion. Etter noen ustabile år har klubben igjen funnet formen og jobber for å kombinere tradisjon og modernitet i Romerikes stolthet.',
  molde:
    'Molde Fotballklubb ble grunnlagt i 1911 og har utviklet seg fra liten kystklubb til nasjonal storklubb. Etter gjennombrudd på 1990-tallet under Åge Hareide, vokste Molde til en toppaktør med solide økonomiske rammer og moderne Aker Stadion. Klubben har vunnet flere seriemesterskap og cupgull og har hatt suksess i Europa. Kjennetegnet er profesjonell drift, ungdomssatsing og offensiv fotball. Molde har vært sentral i å løfte norsk fotballs nivå og representerer kontinuitet og ambisjon.',
  odd:
    'Odds Ballklubb, grunnlagt i 1894, er Norges eldste fotballklubb og har spilt en sentral rolle i sportens utvikling her til lands. Klubben vant en rekke cupgull på 1900-tallet og ble kjent for teknisk og disiplinert spill. I moderne tid har Odd etablert seg som stabil Eliteserie-klubb med Skagerak Arena som hjemmebane. Klubben legger vekt på lokal forankring, ungdomsutvikling og et offensivt, attraktivt spill. Odd representerer Skiens stolthet og norsk fotballs historiske røtter.',
  rosenborg:
    'Rosenborg Ballklub ble stiftet i 1917 og er Norges mestvinnende klubb. Under Nils Arne Eggen dominerte RBK 1990-tallet med 13 strake seriegull og jevnlig deltakelse i Champions League. Klubben ble kjent for sin 4-3-3-filosofi, offensive stil og utvikling av egne spillere. Lerkendal Stadion ble et symbol på trøndersk fotballkultur og samhold. RBK har vært avgjørende for norsk fotballs internasjonale anerkjennelse og jobber i dag for å bygge en ny æra basert på egne tradisjoner.',
  sandefjord:
    'Sandefjord Fotball ble etablert i 1998 etter sammenslåing av Runar og Sandefjord BK. Klubben har hatt flere perioder i Eliteserien og kjennetegnes av profesjonell drift og sterk lokal støtte. På moderne Komplett.no Arena spiller laget offensiv og underholdende fotball, med fokus på utvikling av unge spillere. Klubben har bygget en solid struktur og representerer et forbilde for mindre byer som ønsker bærekraftig toppfotball, preget av stolthet og lojalitet.',
  sarpsborg08:
    'Sarpsborg 08 FF ble stiftet i 2008 etter sammenslåing av flere lokale klubber og er Østfolds store flaggskip. Klubben rykket raskt opp til Eliteserien og har etablert seg som en stabil og velorganisert klubb kjent for intensitet og kollektivt press. Høydepunktet kom i 2018 da Sarpsborg kvalifiserte seg til gruppespill i Europa League. Med Stadion Sarpsborg som base og stor lokal støtte representerer klubben ny suksess i en by med lange fotballtradisjoner.',
  stromsgodset:
    'Strømsgodset Toppfotball fra Drammen ble grunnlagt i 1907 og har en rik historie med både oppturer og nedturer. Klubben vant seriegull i 1970 og 2013 og har fostret mange profiler. Med Marienlyst Stadion som hjemmebane er «Godset» kjent for sin fargerike supporterkultur og offensive spillestil. Klubben legger vekt på talentutvikling og lokal forankring, og representerer Drammens energi, samhold og gjenoppbyggingsevne gjennom mer enn et århundre.',
  tromso:
    'Tromsø Idrettslag ble stiftet i 1920 og er landets nordligste toppklubb. «Gutan» har vært et symbol på nordnorsk fotball, kjent for å utfordre storklubbene med begrensede ressurser. Klubben vant NM i 1986 og 1996 og har jevnlig spilt i Eliteserien. Alfheim Stadion, med sine værharde forhold, er legendarisk i norsk fotball. Tromsø er kjent for teknisk og offensiv stil, sterk lokal forankring og en kultur preget av stolthet og samhold i nord.',
  viking:
    'Viking Fotballklubb ble grunnlagt i 1899 i Stavanger og er en av Norges mest tradisjonsrike klubber. Med åtte seriemesterskap og seks NM-gull har Viking en stolt plass i norsk fotballhistorie. Klubben opplevde storhetstid på 1970-tallet og har siden hatt flere oppturer, blant annet cupgull i 2019. SR-Bank Arena er hjemmebanen, og klubbens supportere, Vikinghordene, gir byen liv og identitet. Viking representerer rogalandsk styrke, offensiv fotball og utrettelig lokal stolthet.',
}
